...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbsignup.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        lbsignup.setForeground(new java.awt.Color(255, 204, 51));
        ...
        lbforgotpw.setText("Forgot password");
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        try {
            ...
            String sql = "SELECT * FROM login WHERE username = ? AND sandi = ?";
